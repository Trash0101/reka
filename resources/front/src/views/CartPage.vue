  ...
  <div class="cart-grid">
    <div class="link">
      <div class="link__wrapper">
        ...
        <router-link class="link__main" to="/catalogue">Вернутся к покупкам</router-link>
      </div>
    </div>
    <cart-items class="cart-grid__items" v-if="cartStore.cartItems.length"></cart-items>
    <cart-summary class="cart-grid__summary" v-if="cartStore.cartItems.length"></cart-summary>
