...
import CatalogueChips from "@/src/components/Catalogue/CatalogueChips.vue";
...
<template>
    <div
        v-if="APICall"
        class="catalogue"
        :class="{ 'catalogue--no-filters': !showFilters }"
    >
        <catalogue-top class="catalogue__top"></catalogue-top>
        <catalogue-chips class="catalogue__chips"></catalogue-chips>
        <side-main v-if="showFilters" class="catalogue__side"></side-main>
        <catalogue-cards
            :class="{ 'catalogue__cards--no-filters': !showFilters }"
