...
<template>
    <section class="head-catalogue">
        <div class="head-catalogue__text">
            Все изделия
            <span class="head-catalogue__text--small">{{ converted }}</span>
        </div>
        <div class="head-catalogue__filter">
            <div
                @click="catalogueStore.switchFilterVisibility"
                v-if="showFilters"
                class="head-catalogue__wrapper"
            >
                <ph-eye class="head-catalogue__eye"></ph-eye>
                <span class="head-catalogue__text--filter"
