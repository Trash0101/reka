...
import {ref} from "vue";
import type {APIres, Item, MaterialComplex, Materials, QueryParams} from "../types/types";
...
export const useCatalogueStore = defineStore('catalogue', ()=>{
    ...
    const initialSetup = async (params:QueryParams) => {
        try{
            ...
            console.log(catalogueItems.value)
    ...
    const saveVisibilitySettings = ()=> {
        localStorage.setItem('visibility', JSON.stringify({
